           ...
           $("#vr-btn").click(function(){
                   $("body").html("<div class='buttons'>"+
                    ...
                    "<span></span> <span></span> </div> </div>"+
                              "<a-scene>"+
                                 "<a-sky src='https://github.com/panjiangJiang9/3sip-english-breakfast/blob/main/assets/test-img.jpg'></a-sky>"+
                              "</a-scene>");
    ...
    /*      <div class="video_menu">
     ...
     $("#video_box").css("height","100%");
      $("#video_box").html("<div class='video_menu'>"+
                           "<h1>Creative Brewing</h1>"+
                             "<div class='video_item'>"+
                               "<img src='https://github.com/panjiangJiang9/3sip-english-breakfast/blob/main/assets/drink1.png' href='https://www.youtube.com/embed/8kU7d-kk8-g?autoplay=0&fs=0&iv_load_policy=3&showinfo=0&rel=0&cc_load_policy=0&start=0&end=0&origin=http://youtubeembedcode.com'>"+
                               "<p>Summer Drinks</p>"+
                             "</div>"+
                            "<div class='video_item'>"+
                               "<img src='https://github.com/panjiangJiang9/3sip-english-breakfast/blob/main/assets/drink2.png' href='https://www.youtube.com/embed/8sgtZy0E2Fs?autoplay=0&fs=0&iv_load_policy=3&showinfo=0&rel=0&cc_load_policy=0&start=0&end=0&origin=http://youtubeembedcode.com'>"+
                               "<p>Bubble Tea</p>"+
                             "</div>"+
                           "<div class='video_item'>"+
                               "<img src='https://github.com/panjiangJiang9/3sip-english-breakfast/blob/main/assets/drink3.png' href='https://www.youtube.com/embed/8sgtZy0E2Fs?autoplay=0&fs=0&iv_load_policy=3&showinfo=0&rel=0&cc_load_policy=0&start=0&end=0&origin=http://youtubeembedcode.com'>"+
                               "<p>Tea Cocktail</p>"+
                             "</div>"+
                           "</div>"
                          );
