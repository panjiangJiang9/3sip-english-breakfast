    ...
    /*      <div class="video_menu">
     ...
     $("#video_box").css("height","100%");
      $("#video_box").html("<div class='video_menu'>"+
                           "<h1>Creative Brewing</h1>"+
                             "<div class='video_item'>"+
                               "<img src='https://cdn.glitch.global/1765ff47-5e85-4c40-9872-99e318a4f9e4/drink1.png?v=1659302628263' href='https://www.youtube.com/embed/8kU7d-kk8-g?autoplay=0&fs=0&iv_load_policy=3&showinfo=0&rel=0&cc_load_policy=0&start=0&end=0&origin=http://youtubeembedcode.com'>"+
                               "<p>Summer Drinks</p>"+
                             "</div>"+
                            "<div class='video_item'>"+
                               "<img src='https://cdn.glitch.global/1765ff47-5e85-4c40-9872-99e318a4f9e4/drink2.png?v=1659302628263' href='https://www.youtube.com/embed/8sgtZy0E2Fs?autoplay=0&fs=0&iv_load_policy=3&showinfo=0&rel=0&cc_load_policy=0&start=0&end=0&origin=http://youtubeembedcode.com'>"+
                               "<p>Bubble Tea</p>"+
                             "</div>"+
                           "<div class='video_item'>"+
                               "<img src='https://cdn.glitch.global/1765ff47-5e85-4c40-9872-99e318a4f9e4/drink3.png?v=1659302628262' href='https://www.youtube.com/embed/8sgtZy0E2Fs?autoplay=0&fs=0&iv_load_policy=3&showinfo=0&rel=0&cc_load_policy=0&start=0&end=0&origin=http://youtubeembedcode.com'>"+
                               "<p>Tea Cocktail</p>"+
                             "</div>"+
                           "</div>"
                          );
